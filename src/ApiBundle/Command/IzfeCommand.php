...
class IzfeCommand extends ContainerAwareCommand
{
    ...
    function addOrria($A204AYUNTA,$IdPagina, $denomi, $titcast, $titeus, $publicada, $tipo) {
        ...
        break;
            default:
                $servicios = array("UML","UPF", "URM", "UEX", "UPM-PM", "UPM-PV", "UPM-CE", "UPM-HE", "URG", "URA", "URB", "UVD",);
    ...
    function addElementua ($A204AYUNTA,$idElementua, $denomi, $titcast, $titeus, $tipo) {
        ...
        $sql = "INSERT INTO UDAA20201 (A202AYUNTA, A202IDLINEA, A202DENOMI, A202TEXCAST, A202TEXEUSK, A202LINKEXT, A202SERVICIO)
            VALUES($A202AYUNTA, $A202IDLINEA, $A202DENOMI, $A202TEXCAST, $A202TEXEUSK, $A202LINKEXT, $A202SERVICIO);\n";
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $labelak = $query->getSingleResult();
            ...
            foreach ($fitxak as $fitxa) {
                $sql = $sql.$this->addOrria( $A204AYUNTA, $idPagina,$fitxa->getEspedientekodea(),$fitxa->getEspedientekodea(), $fitxa->getDeskribapenaeu(),1, "UXX" );
                ...
                if (($eremuak['norkeskatutext']) || ($eremuak['norkeskatutable']))  {
                    ...
                    if ( $eremuak['norkeskatutext']) {
                        ...
                        $idElementua+=1;
                        $idOrdenElementua+=1;
                    } else if ($eremuak["norkeskatutable"]){
