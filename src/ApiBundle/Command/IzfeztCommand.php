                    ...
                    if ( ! in_array(
                        ...
                        if ( $eremuak[ 'helburuatext' ] ) {
                            ...
                            $sql              = $sql . $this->addElementua(
                                    ...
                                    "Texto",
                                    $fitxa->getHelburuaes(
                                    ) . "<span id='kodea' style='display:none;'>" . $fitxa->getEspedientekodea(
                                    ) . "</span>",
                                    $fitxa->getHelburuaeu(
                                    ) . "<span id='kodea' style='display:none;'>" . $fitxa->getEspedientekodea(
                                    ) . "</span>",
                        ...
                        if ( ( $eremuak[ 'dokumentazioatext' ] ) || ( $eremuak[ 'dokumentazioatable' ] ) ) {
                            ...
                            if ( $eremuak[ "dokumentazioatable" ] ) {
                                if ( $fitxa->getDokumentazioak() ) {
                                    ...
                                    foreach ( $fitxa->getDokumentazioak() as $doc ) {
                                        ...
                                        if ( $doc->getEstekaeu() ) {
                                            $doctextes = $doctextes . "<a href='" . $doc->getEstekaes(
                                                ) . "' target='_blank'>" . $doc->getKodea(
                                                ) . " " . $doc->getDeskribapenaes() . "</a>";
                                            $doctexteu = $doctexteu . "<a href='" . $doc->getEstekaeu(
                                                ) . "' target='_blank'>" . $doc->getKodea(
                            ...
                            if ( $eremuak[ 'dokumentazioatext' ] ) {
                                if ( ( $fitxa->getDokumentazioaes() !== null ) || ( $fitxa->getDokumentazioaeu(
                                        ) !== null )
                                ) {
                                    $sql              = $sql . $this->addElementua(
                                            $A204AYUNTA,
                            ...
                            if ( $eremuak[ "doklaguntable" ] ) {
                                if ( $fitxa->doklagunak() ) {
                                    ...
                                    foreach ( $fitxa->doklagunak() as $doc ) {
                                        ...
                                        if ( $doc->getEstekaeu() ) {
                                            $doctextes = "<a href='" . $doc->getEstekaes(
                                                ) . "' target='_blank'>" . $doc->getKodea(
                                                ) . " " . $doc->getDeskribapenaes() . "</a>";
                                            $doctexteu = "<a href='" . $doc->getEstekaeu(
                                                ) . "' target='_blank'>" . $doc->getKodea(
                                                ) . " " . $doc->getDeskribapenaeu() . "</a>";
                                        } else {
                                        ...
                                        if ( ( $kanala->getKanalmota() == $k ) && ( $kanala->getErakutsi() == 1 ) ) {
                                            ...
                                            if ( $kanala->getTelematikoa() ) {
                                                if ( $fitxa->getZerbitzua() ) {
                                                    $textes = $textes . "<li><a href='" . $fitxa->getZerbitzua(
                                                        )->getErroaes() . $fitxa->getUdala()->getKodea(
                                                        ) . $fitxa->getParametroa(
                                                        ) . "' target='_blank'>" . $kanala->getIzenaes() . "</a></li>";
                                                    $texteu = $texteu . "<li><a href='" . $fitxa->getZerbitzua(
                                                        )->getErroaeu() . $fitxa->getUdala()->getKodea(
                                                        ) . $fitxa->getParametroa(
                                                    ...
                                                    if ( $kanala->getIzenaes() ) {
                                                        if ( ( preg_match(
                                                            ...
                                                            $textes = $textes . "<a href='" . $kanala->getEstekaes(
                                                                ) . "' target='_blank'>" . $kanala->getIzenaes(
                                                                ) . "</a><br />";
                        ...
                        if ( ( $eremuak[ 'kostuatext' ] ) || ( $eremuak[ 'kostuatable' ] ) ) {
                                ...
                                if ( $fitxa->getUdala()->getZergaor() ) {
                                    ...
                                    foreach ( $fitxa->getAzpiatalak() as $azpiatal ) {
                                        $textes = $textes . "<table class='table table-bordered table-condensed table-hover'><tr><th colspan=2><a href='http://zergaordenantzak/kudeaketa.php/atala/show/id/" . $azpiatal->getId(
                                            ) . "' target='_blank'>" . $azpiatal->getKodea(
                                            ) . " - " . $azpiatal->getIzenburuaes() . "</a></th></tr>";
                                        $texteu = $texteu . "<table class='table table-bordered table-condensed table-hover'><tr><th colspan=2><a href='http://zergaordenantzak/kudeaketa.php/atala/show/id/" . $azpiatal->getId(
                                            ...
                                            ) . " - " . $azpiatal->getIzenburuaeu() . "</a></th></tr>";

                                        foreach ( $azpiatal->getParrafoak() as $parrafo ) {
                                            $textes = $textes . "<tr><td colspan='2'>" . $parrafo->getTestuaes(
                                                ) . "</td></tr>";
                                            $texteu = $texteu . "<tr><td colspan='2'>" . $parrafo->getTestuaeu(
                                                ) . "</td></tr>";
                                        }
                                        ...
                                        foreach ( $azpiatal->getKontzeptuak() as $kontzeptu ) {
                                            ...
                                            $textes = $textes . "</td><td>" . $kontzeptu->getKopurua(
                                                ) . " " . $kontzeptu->getUnitatea() . "</td></tr>";

                                            $texteu = $texteu . "<tr><td>" . $kontzeptu->getKontzeptuaeu();
                                            if ( $kontzeptu->getBaldintza() ) {
                                                $texteu = $texteu . $kontzeptu->getBaldintza()->getBaldintzaeu();
                                            }
                                            $texteu = $texteu . "</td><td>" . $kontzeptu->getKopurua(
                                                ) . " " . $kontzeptu->getUnitatea() . "</td></tr>";
                                        }
                                        $textes = $textes . "</table><br/>";
                                        $texteu = $texteu . "</table><br/>";
                            ...
                            if ( ( ( $fitxa->getKostuaes() == null ) && ( $kont == 0 ) ) || ( ( $fitxa->getKostuaeu(
                                        ) == null ) && ( $kont == 0 ) )
                            ) {
                                $sql              = $sql . $this->addElementua(
                                        $A204AYUNTA,
                                    ...
                                    foreach ( $fitxa->getAraudiak() as $araua ) {
                                        ...
                                        if ( $araua->getAraudia()->getEstekaeu() ) {
                                            $doctextes = $doctextes . "<a href='" . $araua->getAraudia()->getEstekaes(
                                                ) . "' target='_blank'>" . $araua->getAraudia()->getArauaes(
                                                ) . "</a> " . $araua->getAtalaes();
                                            $doctexteu = $doctexteu . "<a href='" . $araua->getAraudia()->getEstekaeu(
                                                ) . "' target='_blank'>" . $araua->getAraudia()->getArauaeu(
                                                ) . "</a> " . $araua->getAtalaeu();
                                        } else {
                                            $doctextes = $doctextes . $araua->getAraudia()->getArauaes(
                                                ) . " - " . $araua->getAtalaes();
                                            $doctexteu = $doctexteu . $araua->getAraudia()->getArauaeu(
                                                ) . " - " . $araua->getAtalaeu();
                                        }
                                        $doctextes = $doctextes . "</li>";
                                        $doctexteu = $doctexteu . "</li>";
                            ...
                            if ( $eremuak[ "prozeduratable" ] ) {
                                ...
                                if ( $fitxa->getProzedurak() ) {
                                    ...
                                    foreach ( $fitxa->getProzedurak() as $prozedura ) {
                                        $doctextes = $doctextes . "<li>" . $prozedura->getProzedura()->getProzeduraes(
                                            ) . "</li>";
                                        $doctexteu = $doctexteu . "<li>" . $prozedura->getProzedura()->getProzeduraeu(
                                            ) . "</li>";
                                        $badu      = 1;
                                    }
                                    $doctextes = $doctextes . "</ul>";
                            ...
                            if ( $eremuak[ "besteak1table" ] ) {
                                ...
                                if ( $fitxa->getBesteak1ak() ) {
                                    ...
                                    foreach ( $fitxa->getBesteak1ak() as $bes ) {
                                        ...
                                        $doctexteu = $doctexteu . "<li>";
                                        if ( $bes->getEstekaes() ) {
                                            $doctextes = $doctextes . "<a href='" . $bes->getEstekaes(
                                                ) . "'>" . $bes->getIzenburuaes() . "</a>";
                                        } else {
                                            $doctextes = $doctextes . $bes->getIzenburuaes();
                                        }
                                        if ( $bes->getEstekaeu() ) {
                                            $doctexteu = $doctexteu . "<a href='" . $bes->getEstekaeu(
                                                ) . "'>" . $bes->getIzenburuaeu() . "</a>";
                                        } else {
                ...
                foreach ( $c->getFitxafamilia() as $fitx ) {
                    ...
                    if ( ! in_array( $c->getId(), $sortutakoAzpifamiliak ) ) {
                        ...
                        $sql = $sql . $this->addElementua(
                                ...
                                $idElementua,
                                "Texto",
                                "<br/><span class='bold' style='font-style:normal !important'>" . $c->getFamiliaes(
                                ) . "</span>",
                                "<br/><span class='bold' style='font-style:normal !important'>" . $c->getFamiliaeu(
                                ) . "</span>",
                                "PARRAFO"
                            );
                        $sql = $sql . $this->addElementuaBloque(
                    ...
                    if ( 1 == 1 ) { // Folding egiteko addFitxa bezala refaktorizatu beharko zen
                        ...
                        if ( ! in_array(
                                    ...
                                    if ( $fitxa->getDokumentazioak() ) {
                                        ...
                                        foreach ( $fitxa->getDokumentazioak() as $doc ) {
                                            ...
                                            if ( $doc->getEstekaeu() ) {
                                                ...
                                                $doctextes = $doctextes . $doc->getKodea(
                                                    ) . " " . $doc->getDeskribapenaes();
                                                $doctexteu = $doctextes . $doc->getKodea(
                                                    ) . " " . $doc->getDeskribapenaeu();
                                            }
                                            $doctextes = $doctextes . "</li>";
                                            $doctexteu = $doctexteu . "</li>";
                                            $badu      = 1;
                            ...
                            if ( ( $eremuak[ 'kanalatext' ] ) || ( $eremuak[ 'kanalatable' ] ) ) {
                                ...
                                if ( $eremuak[ "kanalatable" ] ) {
                                    ...
                                    foreach ( $kanalmotak as $k ) {
                                        ...
                                        /** @var  $kanala \Zerbikat\BackendBundle\Entity\Kanala */
                                        foreach ( $fitxa->getKanalak() as $kanala ) {
                                            if ( ( $kanala->getKanalmota() == $k ) && ( $kanala->getErakutsi(
                                                    ) == 1 )
                                            ) {
                                                if ( $aurkitua == 0 ) {
                                                    if ( $k->getIkonoa() ) {
                                ...
                                if ( $eremuak[ "araudiatable" ] ) {
                                    ...
                                    if ( $fitxa->getAraudiak() ) {
                                        ...
                                        foreach ( $fitxa->getAraudiak() as $araua ) {
                                            ...
                                            if ( $araua->getAraudia()->getEstekaeu() ) {
                                                $doctextes = $doctextes . "<a href='" . $araua->getAraudia(
                                                    )->getEstekaes() . "' target='_blank'>" . $araua->getAraudia(
                                                    )->getArauaes() . "</a> " . $araua->getAtalaes();
                                                $doctexteu = $doctexteu . "<a href='" . $araua->getAraudia(
                                                    )->getEstekaeu() . "' target='_blank'>" . $araua->getAraudia(
                                                    )->getArauaeu() . "</a> " . $araua->getAtalaeu();
                                            } else {
                                                $doctextes = $doctextes . $araua->getAraudia()->getArauaes(
                                                    ) . " - " . $araua->getAtalaes();
                                                $doctexteu = $doctexteu . $araua->getAraudia()->getArauaeu(
                            ...
                            if ( ( $eremuak[ 'prozeduratext' ] ) || ( $eremuak[ 'prozeduratable' ] ) ) {
                                ...
                                $badu = 0;
                                if ( $eremuak[ 'prozeduratext' ] ) {
                                    if ( ( $fitxa->getProzeduraes() !== null ) || ( $fitxa->getProzeduraeu(
                                            ) !== null )
                                    ) {
                                        $sql              = $sql . $this->addElementua(
                                                $A204AYUNTA,
                                ...
                                if ( $eremuak[ "prozeduratable" ] ) {
                                    ...
                                    if ( $fitxa->getProzedurak() ) {
                                        ...
                                        $doctexteu = "<ul>";
                                        foreach ( $fitxa->getProzedurak() as $prozedura ) {
                                            $doctextes = $doctextes . "<li>" . $prozedura->getProzedura(
                                                )->getProzeduraes() . "</li>";
                                            $doctexteu = $doctexteu . "<li>" . $prozedura->getProzedura(
                                                )->getProzeduraeu() . "</li>";
                                            $badu      = 1;
                                        }
                                        $doctextes = $doctextes . "</ul>";
                            ...
                            if ( ( $eremuak[ 'azpisailatable' ] ) ) {
                                ...
                                if ( $fitxa->getAzpisaila() ) {
                                    ...
                                    $sql              = $sql . $this->addElementua(
                                            ...
                                            $idElementua,
                                            "Texto",
                                            $fitxa->getAzpisaila()->getSaila()->getSailaes(
                                            ) . " - " . $fitxa->getAzpisaila()->getAzpisailaes(),
                                            $fitxa->getAzpisaila()->getSaila()->getSailaeu(
                                            ) . " - " . $fitxa->getAzpisaila()->getAzpisailaeu(),
                                            "PARRAFO"
                                        );
                                    $sql              = $sql . $this->addElementuaBloque(
                                            $A204AYUNTA,
