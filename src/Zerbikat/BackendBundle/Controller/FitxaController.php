...
//     *
//     * @Route("/fitxapi/{id}", name="fitxa_api")
//     * @Method("GET")
//     */
//    public function fitxapiAction(Fitxa $fitxa)
//    {
...
////        $serializer->serialize($fitxa, 'xml');
////        $data = $serializer->deserialize($inputStr, $typeName, $format);
//
//
////        return $this->render('fitxa/fitxapi.html.twig', array(
////            'data' => $data,
////        ));
//
